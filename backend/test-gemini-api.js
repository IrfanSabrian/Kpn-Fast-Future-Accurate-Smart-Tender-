...
async function testGeminiAPI() {
  ...
  try {
    ...
    console.error('2. Enable API: https://console.cloud.google.com/apis/library/generativelanguage.googleapis.com');
    console.error('3. Check quota: https://console.cloud.google.com/apis/dashboard');
