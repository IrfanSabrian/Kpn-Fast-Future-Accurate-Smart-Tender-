 ...
 * Referensi Routes
 */
router.post("/:personelId/referensi", upload.single("file"), addReferensi);
router.put("/:personelId/referensi", upload.single("file"), updateReferensi);
router.delete("/:personelId/referensi/:id", deleteReferensi);

/**
 * STNK Routes
 */
router.post("/:personelId/stnk", upload.single("file"), addStnk);
router.put("/:personelId/stnk", upload.single("file"), updateStnk);
router.delete("/:personelId/stnk/:id", deleteStnk);
